...
from yolox.utils import postprocess, time_synchronized, is_main_process
...
class VOCEvaluator:
    ...
    def evaluate(
        ...
        statistics = flow.Tensor([inference_time, nms_time, n_samples])
    ...
    def evaluate_prediction(self, data_dict, statistics):
        ...
        for img_num in range(self.num_images):
            ...
            for j in range(self.num_classes):
                ...
                c_dets = flow.cat((bboxes, scores.unsqueeze(1)), dim=1)
