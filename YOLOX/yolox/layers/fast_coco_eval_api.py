...
def InstanceAnnotation(id, score, area, iscrowd, ignore):
    return (id, score, area, iscrowd, ignore)
...
def COCOevalEvaluateImages(
    ...
    return (areaRng, maxDet, iouThrs,ious, ground_truth_instances, detected_instances)
    
def COCOevalAccumulate(paramsEval, evalImgs_cpp):
    return(paramsEval, evalImgs_cpp)
