...
class Exp(BaseExp):
    ...
    def random_resize(self, data_loader, epoch, rank):
        tensor = flow.Tensor(2).to(dtype=flow.int64, device="cuda")
    ...
    def get_eval_loader(self, batch_size, testdev=False):
        ...
        sampler = flow.utils.data.SequentialSampler(valdataset)
        ...
        val_loader = flow.utils.data.DataLoader(valdataset, **dataloader_kwargs)
